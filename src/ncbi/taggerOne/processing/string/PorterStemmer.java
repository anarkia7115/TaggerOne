...
public class PorterStemmer implements StringProcessor {
	...
	private PorterStemmerInternal stemmer; // TODO CONCURRENCY Use a ThreadLocal instance

	public PorterStemmer() {
		this.stemmer = new PorterStemmerInternal();
	}
	 ...
	 * Release 3.
	 * 
	 * [ This version is derived from Release 3, modified by Brian Goetz to optimize for fewer object creations. ]
	 */
	...
	private class PorterStemmerInternal implements Serializable {
		...
		/**
		 * After a word has been stemmed, it can be retrieved by toString(), or a reference to the internal buffer can be retrieved by getResultBuffer and getResultLength (which is generally more
		 * efficient.)
		 */
		@Override
		...
		/**
		 * Stem a word contained in a portion of a char[] array. Returns true if the stemming process resulted in a word different from the input. You can retrieve the result with
		...
		/**
		 * Stem a word contained in a leading portion of a char[] array. Returns true if the stemming process resulted in a word different from the input. You can retrieve the result with
		 * getResultLength()/getResultBuffer() or toString().
		 */
